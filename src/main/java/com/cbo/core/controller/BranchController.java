...
public class BranchController {
    ...
    @GetMapping(value = URIS.BRANCH_LIST, consumes = MediaType.APPLICATION_JSON_VALUE,
    ...
    @GetMapping(value = URIS.BRANCH_BY_ID, consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE)
    //@PreAuthorize("hasAnyRole('SASV_ADMIN','SASV_VIEW')")
